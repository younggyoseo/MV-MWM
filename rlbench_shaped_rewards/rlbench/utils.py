            ...
            for i in range(num_steps):
                ...
                if (
                    ...
                    if obs_config.left_shoulder_camera.depth:
                        ...
                        obs[
                            i
                        ].left_shoulder_depth = obs_config.left_shoulder_camera.depth_noise.apply(
                            d
                        )
                    else:
                ...
                if (
                    ...
                    if obs_config.right_shoulder_camera.depth:
                        ...
                        obs[
                            i
                        ].right_shoulder_depth = obs_config.right_shoulder_camera.depth_noise.apply(
                            d
                        )
                    else:
                ...
                if (
                    ...
                    if obs_config.overhead_camera.depth:
                        ...
                        obs[
                            i
                        ].overhead_depth = obs_config.overhead_camera.depth_noise.apply(
                            d
                        )
                    else:
                ...
                if obs_config.left_shoulder_camera.point_cloud:
                    obs[
                        i
                    ].left_shoulder_point_cloud = VisionSensor.pointcloud_from_depth_and_camera_params(
                        l_sh_depth_m,
                ...
                if obs_config.right_shoulder_camera.point_cloud:
                    obs[
                        i
                    ].right_shoulder_point_cloud = VisionSensor.pointcloud_from_depth_and_camera_params(
                        r_sh_depth_m,
                ...
                if obs_config.wrist_camera.point_cloud:
                    obs[
                        i
                    ].wrist_point_cloud = VisionSensor.pointcloud_from_depth_and_camera_params(
                        wrist_depth_m,
